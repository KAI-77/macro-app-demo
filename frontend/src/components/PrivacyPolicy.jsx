...
return (
    ...
    <Heading size="md" mt={4}>1. Data Collection</Heading>
    <Text mb={2}>
    ...
    <Heading size="md" mt={4}>2. Data Usage</Heading>
    <Text mb={2}>
    ...
    <Heading size="md" mt={4}>3. Data Retention</Heading>
    <Text mb={2}>
